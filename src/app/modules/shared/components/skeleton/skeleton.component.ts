...
@Component({
  ...
  template: `
    <div 
      ...
      <div *ngIf="type === 'avatar'" class="w-10 h-10 bg-gray-200 rounded-full dark:bg-gray-700 animate-pulse"></div>
      ...
      <div *ngIf="type === 'publication'" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 space-y-4">
        <div class="flex items-center space-x-4">
          <div class="w-10 h-10 bg-gray-200 rounded-full dark:bg-gray-700 animate-pulse"></div>
      ...
      <div *ngIf="type === 'profile'" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
        ...
        <div class="relative px-4 pb-4">
          <div class="flex items-end space-x-4 -mt-8 mb-5">
            <div class="w-20 h-20 bg-gray-200 rounded-full border-4 border-white dark:border-gray-800 dark:bg-gray-700 animate-pulse"></div>
            <div class="flex-1 space-y-2">
      ...
      <div *ngIf="type === 'comment'" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 space-y-3">
        <div class="flex items-center space-x-3">
          <div class="w-8 h-8 bg-gray-200 rounded-full dark:bg-gray-700 animate-pulse"></div>
