...
export const APP_VERSION_CONFIG: AppVersionConfig = {
  ...
  changelog: `
    🐛 CORRECCIONES (v3.5.2 — 2026-06-14):
    - Fixed: En móvil (iOS PWA) el menú del avatar no llegaba al fondo de la pantalla
      (franja con la barra inferior visible) — ahora usa el alto real del viewport
